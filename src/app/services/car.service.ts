...
export class CarService {
  ...
  getLastCar() {
    return this.httpClient.get<ListResponseModel<CarOperations>>(this.apiUrl);
  }
  ...
  addCar(car: CarOperations): Observable<ResponseModel> {
  ...
  updateCar(car: CarOperations): Observable<ResponseModel> {
